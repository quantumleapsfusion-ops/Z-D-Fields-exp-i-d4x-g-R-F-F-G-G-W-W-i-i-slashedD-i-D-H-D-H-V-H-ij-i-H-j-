    ...
    <div className={`flex flex-col gap-2 ${className}`}>
      <div className="flex items-center gap-3">
        ...
        >
          <span
            aria-hidden="true"
            className={`h-2 w-2 rounded-full ${live.listening ? "bg-blackboard animate-pulse" : "bg-ochre"}`}
          />
        ...
        >
          <input
            ...
            className="border-chalk/15 text-chalk placeholder:text-dust/60 focus:border-ochre h-11 w-full min-w-0 rounded-full border bg-transparent px-4 font-sans text-sm focus:outline-none"
          />
        </form>
      </div>
