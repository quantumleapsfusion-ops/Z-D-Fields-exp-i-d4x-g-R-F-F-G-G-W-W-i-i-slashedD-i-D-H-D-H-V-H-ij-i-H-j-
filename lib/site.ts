export const site = {
  ...
  community: 'audiophiles in audiofiles',
  description:
    'e1-4 — earth life-forms. A voice-only social network: speak, and transcription, translation and visuals follow. Every person gets an audio diary through Voice Stream.',
} as const;
